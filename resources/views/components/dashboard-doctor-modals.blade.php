            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    @forelse ($caregivers as $caregiver)
                        <button class="btn btn-outline-primary w-100 mb-2" data-bs-toggle="modal" data-bs-target="#cgDetailsModal-{{ $caregiver->ID_CG }}">{{ $caregiver->Date_CG }}</button>
                    @empty
                        <p>ไม่พบข้อมูล CG</p>
                    @endforelse
                </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    @endphp
                    @forelse ($caregivers as $caregiver)
                        <button class="btn btn-outline-primary w-100 mb-2" data-bs-toggle="modal" data-bs-target="#cgForACGModal-{{ $caregiver->ID_CG }}">{{ $caregiver->Date_CG }}</button>
                    @empty
                        <p>ไม่พบข้อมูล CG</p>
                    @endforelse
                </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        @forelse ($activities as $activity)
                            <button class="btn btn-outline-info w-100 mb-2" data-bs-toggle="modal" data-bs-target="#acgDetailsModal-{{ $activity->ID_ACG }}">{{ $activity->Date_ACG }}</button>
                        @empty
                            <p>ไม่พบข้อมูล ACG</p>
                        @endforelse
                    </div>
